use crate::{core::Fridgerator, il2cpp::{ext::LocalizedDataExt, hook::Unity_TextMeshPro::TMP_Text, symbols::get_method_addr, types::*}};

type AwakeFn = extern "C" fn(this: *mut Il2CppObject);
extern "C" fn Awake(this: *mut Il2CppObject) {
    get_orig_fn!(Awake, AwakeFn)(this);

    let tmp_font = Fridgerator::instance().localized_data.load().load_tmp_replacement_font();
    if !tmp_font.is_null() {
