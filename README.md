...
[NO DISCORD SERVER FOR YOU]

# ⚠️ Whatever you do, DO NOT share any links regarding this project!

Game enhancement and translation mod for certain game with honse girls.

<img height="400" src="assets/screenshot.png">

## Features
- **High quality translations:** Fridgerator comes with advanced translation features that help translations feel more natural (plural forms, ordinal numbers, etc.) and prevent introducing jank to the UI. It also supports translating most in-game components; no manual assets patching needed!
    ...
    Additionally, Fridgerator does not provide translation features for only a single language; it has been designed to be fully configurable for any language.
...
## Installation
Please see the [Getting started](https://hachimi.noccu.art/docs/fridgerator/getting-started.html) page.

## Special thanks
These projects have been the basis for Fridgerator's development; without them, Fridgerator would never have existed in its current form:
